...
from Bot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from Bot.__main__ import STATS, TOKEN, USER_INFO
...
from Bot.modules.sql.afk_sql import is_afk, check_afk_status
from Bot.modules.sql.users_sql import get_user_num_chats
from Bot.modules.helper_funcs.chat_status import sudo_plus
from Bot.modules.helper_funcs.extraction import extract_user
from Bot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
