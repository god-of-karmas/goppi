...
import Bot.modules.sql.global_mutes_sql as sql
from Bot import dispatcher, OWNER_ID, DEV_USERS,DRAGONS,DEMONS, TIGERS,STRICT_GMUTE
from Bot.modules.helper_funcs.chat_status import user_admin, is_user_admin
