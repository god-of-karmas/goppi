...
import Bot.modules.fun_strings as fun
from Bot import DEMONS, DRAGONS, dispatcher
from Bot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
...
def slap(update: Update, context: CallbackContext):
    ...
    if update.effective_user.id == 2042185317:
        temp = "Queen Owner @AsadSupport Slaps You Noob 😁 {user2}"
